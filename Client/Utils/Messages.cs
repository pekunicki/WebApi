namespace Client.Utils
{
    ...
    {
        public static string SuccessRegistrationMsg => "You've successfully registered your account!";
        public static string SuccessLoginMsg => "You've successfully retrieved access token!";
        public static string SuccessChangePasswordMsg => "You've changed your password!";
